...
- 🚀 Data-driven design optimization: Leveraging the dataset to optimize vehicle designs based on aerodynamic performance.
- 🧠 Generative AI: Training generative models to create new car designs based on aerodynamic performance or aesthetic considerations.
- 🎯 Surrogate models: Developing surrogate models to predict aerodynamic performance without running full CFD simulations.
- 🔥 CFD simulation acceleration: Accelerating simulations using machine learning and multi-GPU techniques.
- 📉 Reduced Order Modeling: Creating data-driven reduced-order models for efficient & fast aerodynamic simulations.
- 💾 Large-Scale Data Handling: Developing methods for efficient storage and handling of the extensive dataset generated by high-fidelity simulations.
- 🗜️ Data Compression: Implementing high-performance lossless compression and decompression techniques to manage large-scale simulation data effectively.
- 🌐 Part and shape classification: Classifying car categories or specific car components to enhance design analysis.
- 🔧 Automated CFD meshing: Automating the meshing process based on given car components to streamline simulation setup.
